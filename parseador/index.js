...
//var fecha = 2017-09-22;
    ...
    request("http://www.elcomparador.com/html/contenido/mas_partidos.php?deporte=1&fecha=2017-09-23&offset=30", function (err, codigoGeneral) {
        ...
        for (i = 1; i < competiciones.length; i++) {  //Iterador asociado a cada una de las competiciones
            ...
            for(j=1; j<eventos_competicion.length; j++) {

                //console.log("______________________________________________________________________________________________________" + eventos_competicion.length);
                ...
                var equipos_competicion = eventos_competicion[j].split(" <span class=\"equipo\">");
                ...
                if (equipo2_pos == -1) {
                    ...
                    var equipo2_aux1 = equipos_competicion[2].substr(equipo2_pos1).split("\">", 2);
                ...
                var cuotas_general = eventos_competicion[j].split("<div id=\"contenedor_cuotas\">")
